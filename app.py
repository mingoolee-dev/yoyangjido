...
def calc(request: Request,
    ...
    qa = [
        ...
        ("기초생활수급자는 요양원 비용이 얼마인가요?",
         ...
         "보건복지부장관이 고시한 소득·재산 기준 이하인 분은 40% 또는 60%를 감경받습니다. "
         "다만 누가 대상인지를 정하는 2026년 소득·재산 기준 고시를 저희가 확인하지 못했으므로 "
         "금액 기준은 적지 않습니다. 국민건강보험공단 1577-1000에서 대상 여부를 바로 확인해 줍니다. "
...
def 글_요양원_요양병원(request: Request):
    ...
    qa = [
        ...
        ("장기요양보험에 '요양병원간병비'가 있다고 들었습니다.",
         ...
         "다만 '지급할 수 있다'는 임의 규정이라, 실제로 받을 수 있는지는 "
         "국민건강보험공단 1577-1000에 확인하셔야 합니다. "
         "저희는 확인하지 못한 것을 확인한 것처럼 적지 않습니다."),
        ("요양원 본인부담금을 깎아주는 제도가 있습니까?",
         "있습니다. 의료급여 수급권자는 본인일부부담금의 60%를, "
         "보건복지부장관이 고시한 소득·재산 기준 이하인 분은 40% 또는 60%를 감경받습니다. "
         "다만 '누가 대상인지'를 정하는 2026년 소득·재산 기준 고시를 저희가 확인하지 못했으므로 "
         "금액 기준은 적지 않습니다. 국민건강보험공단 1577-1000에서 "
         "본인이 대상인지 바로 확인해 주십니다. "
         "출처: 국민건강보험공단 장기요양보험료 및 본인부담금 안내."),
    ]
